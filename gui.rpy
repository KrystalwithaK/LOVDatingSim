...
define gui.main_menu_background = "main_blink"
...
define gui.namebox_height = 105

#both used to be none

## The borders of the box containing the character's name, in left, top, right, bottom order.
#define gui.namebox_borders = Borders(5, 5, 5, 5)
define gui.namebox_borders = Borders(25, 10, 25, 10)
